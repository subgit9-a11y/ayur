                                                            ...
                                                            children: [
                                                              TextField(
                                                                ...
                                                                decoration: InputDecoration(
                                                                    hintText: getTranslated(
                                                                            context,
                                                                            AppString.profile_dialog_degree_hint)
                                                                        .toString()),
                                                              ),
                                                              TextField(
                                                                onChanged:
                                                                ...
                                                                decoration: InputDecoration(
                                                                    hintText: getTranslated(
                                                                            context,
                                                                            AppString.profile_dialog_education)
                                                                        .toString()),
                                                              ),
                                                              TextField(
                                                                onChanged:
                                                              ...
                                                              setState(() {
                                                                if (_degree
                                                                  ...
                                                                  addDegree = _pDegree
                                                                      ...
                                                                      _degree
                                                                          .text;
                                                                  addCollege = _pCollege
                                                                          .text +
                                                                      "," +
                                                                      _college
                                                                          .text;
                                                                  addYear = _pCollegeYear
                                                                          .text +
                                                                      "," +
                                                                      _completeYear
                                                                          .text;
                                                              ...
                                                              children: [
                                                                TextField(
                                                                  ...
                                                                  decoration: InputDecoration(
                                                                      hintText: getTranslated(
                                                                              context,
                                                                              AppString.profile_dialog_certificate)
                                                                          .toString()),
                                                                ),
                                                                TextField(
                                                                  onChanged:
                                                              ...
                                                              onPressed: () {
                                                                setState(() {
                                                                  if (_certificate
                                                                    ...
                                                                    addCertificate = _pCertificate
                                                                            .text +
                                                                        "," +
                                                                        _certificate
                                                                            .text;
                                                                    addCertificateYear = _pCertificateYear
                                                                            .text +
                                                                        "," +
                                                                        _year
                                                                            .text;
            ...
            child: OslerButton(
              ...
              onPressed: () {
                if (_currentStep == 0 && _step1.currentState!.validate()) {
                  ...
                  certificateYear =
                      _pCertificateYear.text.toString().split(',');
