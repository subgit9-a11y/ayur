  ...
  Widget build(BuildContext context) {
    ...
    return Stack(
      ...
      appBar: AppBar(
        backgroundColor: Colors.transparent,
        leading: IconButton(
          icon: Icon(Icons.arrow_back_ios, color: GlassTheme.textPrimaryLight, size: 20),
                            ...
                            title: Row(
                              ...
                              children: [
                                ...
                                Expanded(
                                  flex: 2,
                                  child: IconButton(
                                    icon: Icon(Icons.edit_calendar_rounded, color: GlassTheme.primaryGreen, size: 22),
                                    onPressed: () async {
                                      passIndex = index;
                                          ...
                                          return StatefulBuilder(
                                            builder: (context, myState) {
                                              return AlertDialog(
                                                ...
                                                backgroundColor: GlassTheme.bgLight,
                                                title: Column(
                                                  crossAxisAlignment: CrossAxisAlignment.start,
                                                  children: [
                                                    Text(
